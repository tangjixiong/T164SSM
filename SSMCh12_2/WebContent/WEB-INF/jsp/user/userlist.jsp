        ...
        <div class="right">
            ...
            <table class="providerTable" cellpadding="0" cellspacing="0">
                <tr class="firstTr">
                   ...
                   <c:forEach var="user" items="${pages.list }" varStatus="status">
					<tr>
						<td>
						...
						<td>
							<span>${user.rName}</span>
						</td>
						<td>
						<span><a class="viewUser" href="javascript:;" userid=${user.id }><img src="${pageContext.request.contextPath }/images/read.png" alt="查看" title="查看"/></a></span>
						...
						<span><a class="deleteUser" href="javascript:;" userid=${user.id }><img src="${pageContext.request.contextPath }/images/schu.png" alt="删除" title="删除"/></a></span>
						</td>
					</tr>
				</c:forEach>
			</table>
			<input type="hidden" id="totalPageCount" value="${pages.totalPage}"/>
		  	<c:import url="rollpage.jsp">
	          	<c:param name="totalCount" value="${pages.totalCount}"/>
	          	<c:param name="currentPageNo" value="${pages.curPage}"/>
	          	<c:param name="totalPageCount" value="${pages.totalPage}"/>
          	</c:import>
